...
@section('content')
<!-- Hero Section -->
<section class="relative bg-gradient-to-r from-teal-600 to-teal-700 text-white py-20 overflow-hidden">
    <!-- Background Video -->
    ...
    <!-- Overlay -->
    <div class="absolute inset-0 bg-teal-900 bg-opacity-60 z-10"></div>
