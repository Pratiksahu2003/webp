...
@section('content')
<!-- Hero Section -->
<section class="relative bg-gradient-to-r from-pink-600 to-pink-700 text-white py-20 overflow-hidden">
    <!-- Background Video -->
    ...
    <!-- Overlay -->
    <div class="absolute inset-0 bg-pink-900 bg-opacity-60 z-10"></div>
