        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden lg:flex items-center space-x-6">
                    ...
                    <a href="{{ route('contact') }}" class="border-2 border-white text-white px-6 py-2 rounded-full text-sm font-medium uppercase hover:bg-white hover:text-black transition-colors">
                        CONTACT US
                    </a>
                    @auth
