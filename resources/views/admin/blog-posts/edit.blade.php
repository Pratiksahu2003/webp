...
@section('title', 'Edit Blog Post - VanTroZ Admin')
...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
    ...
    <div class="bg-white shadow-sm border-b border-gray-200">
        ...
        <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Blog Post</h1>
                    <p class="text-gray-600">Update and optimize your blog content with advanced SEO features</p>
        </div>
    ...
    <!-- Main Form -->
        <form action="{{ route('admin.blog-posts.update', $blogPost) }}" method="POST" enctype="multipart/form-data" id="blog-form" class="space-y-8">
        @csrf
        @method('PUT')
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div id="scheduled_date" style="display: none;">
                        ...
                        <input type="datetime-local"
                            id="scheduled_at"
                            name="scheduled_at"
                            value="{{ old('scheduled_at', $blogPost->scheduled_at ? $blogPost->scheduled_at->format('Y-m-d\TH:i') : '') }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-black">
                        @error('scheduled_at')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
