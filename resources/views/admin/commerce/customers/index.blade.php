                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/80">
                        ...
                        <td class="px-5 py-4 text-right space-x-3">
                            <a href="{{ route('admin.customers.show', $customer) }}" class="text-sm font-semibold text-teal-700">View</a>
                    ...
                    <tr>
                        <td colspan="6" class="px-5 py-12 text-center text-slate-500">
                            No clients yet. <a href="{{ route('admin.customers.create') }}" class="text-teal-700 font-semibold">Onboard your first client</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
