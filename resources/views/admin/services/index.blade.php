...
@section('title', 'Services Management - VanTroZ Admin')
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Manage your company services and offerings</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div class="h-48 bg-gradient-to-br from-blue-500 to-purple-600 relative">
                ...
                <div class="absolute bottom-4 left-4 text-white">
                    <h3 class="text-xl font-bold">Service {{ $i }}</h3>
                    <p class="text-blue-100">Professional service offering</p>
                </div>
            </div>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="text-sm text-gray-500">{{ now()->subDays(rand(1, 30))->format('M d') }}</span>
                </div>
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center text-sm text-gray-500">
                        ...
                        Starting at ${{ number_format(rand(500, 5000)) }}
                    </div>
                </div>

                <!-- Action Buttons -->
                <div class="flex items-center space-x-2">
                    <a href="{{ route('admin.services.show', $i) }}" 
                    ...
                    <a href="{{ route('admin.services.edit', $i) }}" 
                    ...
                    <form action="{{ route('admin.services.destroy', $i) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" 
        ...
        <div class="col-span-full">
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 mb-6">Start by adding your first service offering.</p>
                <a href="{{ route('admin.services.create') }}" 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900">All Services ({{ rand(5, 15) }})</h3>
                <div class="flex items-center space-x-2">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900">
                                        {{ ['Web Development', 'Mobile App Design', 'SEO Optimization', 'UI/UX Design', 'Digital Marketing'][($i-1) % 5] }}
                                    </div>
                                    <div class="text-sm text-gray-500">
                                        Professional service with modern approach
                                    </div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                {{ ['Development', 'Design', 'Marketing', 'Design', 'Marketing'][($i-1) % 5] }}
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ${{ number_format(rand(500, 5000)) }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
