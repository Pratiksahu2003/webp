        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-12 items-center py-6 sm:py-8 lg:py-12">
            ...
            <div class="lg:col-span-7 space-y-3 sm:space-y-4 md:space-y-5 lg:space-y-6 xl:space-y-8 relative hero-left-content">
                ...
                <div class="flex justify-start">
                    <div class="relative inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-white text-xs sm:text-sm font-medium shadow-lg">
                        <div class="flex items-center">
                            <div class="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-gradient-to-r from-orange-400 to-orange-500 rounded-full mr-1.5 sm:mr-2"></div>
                ...
                <p class="max-w-2xl text-sm sm:text-base md:text-lg lg:text-xl text-slate-200 leading-relaxed font-light hero-subtitle-responsive">
                ...
                <div class="flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-4 pt-1 sm:pt-2">
                    <a href="{{ route('contact') }}" class="inline-flex items-center justify-center px-4 py-2.5 sm:px-5 sm:py-3 md:px-6 md:py-3 lg:px-8 lg:py-4 bg-gradient-to-r from-white to-slate-100 text-slate-900 font-bold rounded-lg sm:rounded-xl shadow-lg w-full sm:w-auto text-sm sm:text-base">
                    ...
                    <a href="{{ route('portfolio') }}" class="inline-flex items-center justify-center px-4 py-2.5 sm:px-5 sm:py-3 md:px-6 md:py-3 lg:px-8 lg:py-4 border-2 border-white/30 text-white font-semibold rounded-lg sm:rounded-xl backdrop-blur-sm w-full sm:w-auto text-sm sm:text-base">
            ...
            <div class="lg:col-span-5 relative flex flex-col justify-center space-y-4 sm:space-y-6 hero-stats-wrapper">
                <div class="relative bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 border border-white/20 shadow-lg hero-main-card">
                ...
                <div class="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4 hero-stats-grid">
                    <div class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 border border-white/20 text-center">
