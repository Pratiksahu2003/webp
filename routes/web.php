...
Route::get('/chatbot/bootstrap', [\App\Http\Controllers\ChatbotController::class, 'bootstrap'])->name('chatbot.bootstrap');
Route::post('/chatbot/message', [\App\Http\Controllers\ChatbotController::class, 'message'])->name('chatbot.message');
Route::post('/chatbot/lead', [\App\Http\Controllers\ChatbotController::class, 'lead'])->name('chatbot.lead');
